...
func TestProcessSteps(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			givenSteps: []*github.TaskStep{
				&github.TaskStep{Name: getPtr("Checkout"), Status: getPtr("completed"), Conclusion: getPtr("success")},
				&github.TaskStep{Name: getPtr("Build"), Status: getPtr("completed"), Conclusion: getPtr("failure")},
				&github.TaskStep{Name: getPtr("Test"), Status: getPtr("completed"), Conclusion: getPtr("success")},
			},
